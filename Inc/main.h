...
#define PB12_START_SW_PIN_EXTI_IRQn EXTI15_10_IRQn
#define FND_SLCK_Pin GPIO_PIN_13
#define FND_SLCK_GPIO_Port GPIOB
...
#define PB5_RE_AY_ON_OFF_CTRL_Pin GPIO_PIN_5
#define PB5_RE_AY_ON_OFF_CTRL_GPIO_Port GPIOB
